      ...
      <vp-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <vp-dropdown-menu slot="dropdown">
          <router-link to="/profile/index">
            <vp-dropdown-item>Profile</vp-dropdown-item>
          </router-link>
          <router-link to="/">
            <vp-dropdown-item>Dashboard</vp-dropdown-item>
          </router-link>
          <a target="_blank" href="https://github.com/PanJiaChen/vue-element-admin/">
            <vp-dropdown-item>Github</vp-dropdown-item>
          </a>
          <a target="_blank" href="https://panjiachen.github.io/vue-element-admin-site/#/">
            <vp-dropdown-item>Docs</vp-dropdown-item>
          </a>
